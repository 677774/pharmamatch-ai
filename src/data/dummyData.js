...
export const moleculeDatabase = [
  { id: 1, name: 'Metformin HCL', type: 'API', cas: '1115-70-4', mw: 165.62, formula: 'C₄H₁₁N₅·HCl', category: 'Antidiabetic', solubility: 'Freely soluble in water', meltingPoint: '223-226°C' },
  { id: 2, name: 'Paracetamol', type: 'API', cas: '103-90-2', mw: 151.16, formula: 'C₈H₉NO₂', category: 'Analgesic', solubility: 'Slightly soluble in water', meltingPoint: '169-172°C' },
  { id: 3, name: 'Ibuprofen', type: 'API', cas: '15687-27-1', mw: 206.28, formula: 'C₁₃H₁₈O₂', category: 'NSAID', solubility: 'Practically insoluble', meltingPoint: '75-78°C' },
  { id: 4, name: 'Microcrystalline Cellulose', type: 'Excipient', cas: '9004-34-6', mw: 36000, formula: '(C₆H₁₀O₅)n', category: 'Diluent/Binder', solubility: 'Insoluble in water', meltingPoint: '260-270°C' },
  { id: 5, name: 'Magnesium Stearate', type: 'Excipient', cas: '557-04-0', mw: 591.27, formula: 'C₃₆H₇₀MgO₄', category: 'Lubricant', solubility: 'Insoluble in water', meltingPoint: '88°C' },
  { id: 6, name: 'Lactose Monohydrate', type: 'Excipient', cas: '64044-51-5', mw: 360.31, formula: 'C₁₂H₂₂O₁₁·H₂O', category: 'Diluent', solubility: 'Freely soluble in water', meltingPoint: '202-203°C' },
  { id: 7, name: 'Povidone K30', type: 'Excipient', cas: '9003-39-8', mw: 40000, formula: '(C₆H₉NO)n', category: 'Binder', solubility: 'Freely soluble in water', meltingPoint: '150°C (decomp)' },
  { id: 8, name: 'Amoxicillin Trihydrate', type: 'API', cas: '61336-70-7', mw: 419.45, formula: 'C₁₆H₁₉N₃O₅S·3H₂O', category: 'Antibiotic', solubility: 'Slightly soluble', meltingPoint: '194°C' },
];
