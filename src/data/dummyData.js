...
export const moleculeDatabase = [
  { id: 14219, name: 'Metformin HCL', type: 'API', cas: '1115-70-4', mw: 165.62, formula: 'C₄H₁₁N₅·HCl', category: 'Antidiabetic', solubility: 'Freely soluble in water', meltingPoint: '223-226°C', smiles: 'CN(C)C(=N)N=C(N)N.Cl', logP: -1.43, has3D: true, image: 'https://pubchem.ncbi.nlm.nih.gov/image/imgsrv.fcgi?cid=14219&t=l' },
  { id: 1983, name: 'Paracetamol', type: 'API', cas: '103-90-2', mw: 151.16, formula: 'C₈H₉NO₂', category: 'Analgesic', solubility: 'Slightly soluble in water', meltingPoint: '169-172°C', smiles: 'CC(=O)NC1=CC=C(O)C=C1', logP: 0.46, has3D: true, image: 'https://pubchem.ncbi.nlm.nih.gov/image/imgsrv.fcgi?cid=1983&t=l' },
  { id: 3672, name: 'Ibuprofen', type: 'API', cas: '15687-27-1', mw: 206.28, formula: 'C₁₃H₁₈O₂', category: 'NSAID', solubility: 'Practically insoluble', meltingPoint: '75-78°C', smiles: 'CC(C)CC1=CC=C(C=C1)C(C)C(=O)O', logP: 3.97, has3D: true, image: 'https://pubchem.ncbi.nlm.nih.gov/image/imgsrv.fcgi?cid=3672&t=l' },
  ...
  { id: 11177, name: 'Magnesium Stearate', type: 'Excipient', cas: '557-04-0', mw: 591.27, formula: 'C₃6H₇₀MgO₄', category: 'Lubricant', solubility: 'Insoluble in water', meltingPoint: '88°C', smiles: 'CCCCCCCCCCCCCCCCCC(=O)[O-].CCCCCCCCCCCCCCCCCC(=O)[O-].[Mg+2]', logP: 14.2, has3D: true, image: 'https://pubchem.ncbi.nlm.nih.gov/image/imgsrv.fcgi?cid=11177&t=l' },
  { id: 6134, name: 'Lactose Monohydrate', type: 'Excipient', cas: '64044-51-5', mw: 360.31, formula: 'C₁₂H₂₂O₁₁·H₂O', category: 'Diluent', solubility: 'Freely soluble in water', meltingPoint: '202-203°C', smiles: 'C(C1C(C(C(C(O1)OC2C(C(OC(C2O)O)CO)O)O)O)O)O.O', logP: -5.0, has3D: true, image: 'https://pubchem.ncbi.nlm.nih.gov/image/imgsrv.fcgi?cid=6134&t=l' },
  ...
  { id: 33613, name: 'Amoxicillin Trihydrate', type: 'API', cas: '61336-70-7', mw: 419.45, formula: 'C₁₆H₁₉N₃O₅S·3H₂O', category: 'Antibiotic', solubility: 'Slightly soluble', meltingPoint: '194°C', smiles: 'CC1(C(N2C(S1)C(C2=O)NC(=O)C(C3=CC=C(C=C3)O)N)C(=O)O)C.O.O.O', logP: 0.87, has3D: true, image: 'https://pubchem.ncbi.nlm.nih.gov/image/imgsrv.fcgi?cid=33613&t=l' },
];
